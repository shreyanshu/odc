...
for record in test_list:
    ...
    outputs = neural.predict(inputs) # 2
...
#     dill.dump(neural, f)
numpy.savetxt('weights_input_hidden.csv', neural.weight_input_hidden, delimiter=",")
numpy.savetxt('weights_hidden_output.csv', neural.weight_hidden_output, delimiter=",")
# pickle.dump(neural, open("model.sav", 'wb'))
